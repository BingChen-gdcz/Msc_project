...
def all_codes(pro_dir,diag_dir):
    ...
    dfpro = dfpro.fillna('NaN')
    dfdiag = dfdiag.fillna('NaN')
...
def code_filter(dficd_codes,df_discharge):
    ...
    with open(outfile,'w') as of:
        ...
        for i in range(dficd_codes.shape[0]):
